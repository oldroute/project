    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_key', project.training.fields.OrderField(blank=True, null=True, verbose_name='порядок')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('show', models.BooleanField(default=True, verbose_name='отображать')),
                ('slug', project.training.fields.SlugField(blank=True, max_length=255, null=True, verbose_name='слаг')),
                ('order_key', project.training.fields.OrderField(blank=True, null=True, verbose_name='порядок')),
